using Cinema_BusinessLayer.Consts;
using Cinema_BusinessLayer.Interfaces;
using Microsoft.EntityFrameworkCore;
using System.Linq.Expressions;

namespace Cinema_DataAccessLayer.Repositories
{
    public class BaseRepository<T> : IBaseRepository<T> where T : class
    {
        ...
        public IQueryable<T> QueryNoTracking() => _context.Set<T>().AsNoTracking().AsQueryable();

        public async Task<IReadOnlyList<T>> Include(params Expression<Func<T, object>>[] includes)
        {
